        ...
        <g fillRule="evenodd" strokeWidth="1" mask="url(#react-mask-5)">
          ...
          <g transform="translate(0 170)">
            <defs>
              <path
                id="react-path-193"
                d="M108 13.07c-17.919 2.006-31.72 7.482-31.996 21.575C50.146 45.568 32 71.165 32 100.999V110h200v-9c0-29.835-18.146-55.432-44.004-66.355-.276-14.093-14.077-19.57-31.996-21.574V32c0 13.255-10.745 24-24 24s-24-10.745-24-24V13.07z"></path>
            </defs>
            <mask id="react-mask-194" fill="#fff">
              <use xlinkHref="#react-path-193"></use>
            </mask>
            <use fill="#B7C1DB" fillRule="evenodd" xlinkHref="#react-path-193"></use>
          ...
          <g fill="#000" transform="translate(76 82)">
            <g fill="#000" fillOpacity="0.6" fillRule="nonzero" transform="translate(2 52)">
            ...
            <g fillOpacity="0.6">
              <g fillRule="nonzero" transform="translate(12 6)">
                ...
                <path
                  ...
                  transform="matrix(-1 0 0 1 146 0)"></path>
              </g>
            </g>
          </g>
            ...
            <g mask="url(#react-mask-103)">
              <g fillRule="evenodd" transform="translate(-1)">
                ...
                <path
                  fill="#000"
                  fillOpacity="0.16"
                  d="M67 113c17.823-32.335 70.535-32.393 87.43-48.792 10.778 8.49 28.462 15.059 34.533 33.66-6.071-21.444-23.755-31.308-34.533-41.09C137.535 75.672 84.823 75.74 67 113z"></path>
              </g>
            </g>
          </g>
        </g>
