...
const AnimatedCursor = ({
  ...
  const onMouseMove = React.useCallback(({ clientX, clientY }) => {
    ...
    cursorInnerRef.current.style.top = clientY + 8 + 'px';
    cursorInnerRef.current.style.left = clientX + 8 + 'px';
  ...
  useEventListener('mousemove', onMouseMove, _document);
  useEventListener('mousedown', onMouseDown, _document);
  useEventListener('mouseup', onMouseUp, _document);
  useEventListener('mouseenter', onMouseEnter, _document);
  useEventListener('mouseleave', onMouseLeave, _document);
